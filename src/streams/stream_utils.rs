...
//         let mut stream_block = String::new();
//         let mut entry_count = 0;

//         {
//             let kv_map_guard = kv_map.lock().await;
//             if let Some(vs) = kv_map_guard.get(stream_key) {
//                 stream_block.push_str("*2\r\n");
//                 stream_block.push_str(&format!("${}\r\n{}\r\n", stream_key.len(), stream_key));
...
//                         {
//                             entry_count += 1;
//                             stream_block.push_str(&ss.to_string());
//                         }
//                     }
//                 }
...
//                 stream_block.push_str("$-1\r\n");
//             }
//         }

//         temp1.push_str(&stream_block);
//         ind += 1;
//     }
